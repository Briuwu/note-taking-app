              ...
              <div className="space-y-2">
                ...
                {note.is_archived && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-preset-5 text-neutral-950 dark:text-white">
                      Archived
                    </span>
                  </div>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="text-preset-5 h-full text-neutral-950">
                    <FormControl>
                      <Textarea
                        disabled={isPending}
                        className="text-preset-5 h-full resize-none whitespace-pre-line border-0 text-neutral-800 shadow-none dark:text-neutral-200"
